...
/**
 * Test for module 4 homework 3 task 2 trucks, containers and boxes. Тест рассчитан для
 * конфигурации, когда в 1 контейнер помещается 27 ящиков и в 1 грузовик помещается 12 контейнеров
 */
